    ...
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) :  IUserAccount
    {
     ...
     await appDbContext.ApplicationUsers.FirstOrDefaultAsync(_ => _.Email!.ToLower()!.Equals(email!.ToLower()));
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null) return new LoginResponse(false, "User not found so refresh token could not generated");
            ...
            if (updateRefreshToken is null) return new LoginResponse(false, "User not sign in so refresh token was failed");
        ...
        //Task<GeneralResponse> IUserAccount.CreateAsync(Register user)
        //{
