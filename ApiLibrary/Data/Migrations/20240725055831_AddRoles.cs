        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NormalUsers_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NormalUsers_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NormalUsers_GeneralDepartments_GeneralDepartmentId",
                        column: x => x.GeneralDepartmentId,
                        principalTable: "GeneralDepartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NormalUsers_Towns_TownId",
                        column: x => x.TownId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_BranchId",
                table: "NormalUsers",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_DepartmentId",
                table: "NormalUsers",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_GeneralDepartmentId",
                table: "NormalUsers",
                column: "GeneralDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_NormalUsers_TownId",
                table: "NormalUsers",
                column: "TownId");
        }
